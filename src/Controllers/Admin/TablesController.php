...
use Decoweb\Panelpack\Services\Tables;
...
class TablesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('decoweb::admin.tables.index', compact('tabele'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('decoweb::admin.tables.create',compact('columns','tabele','types' ));
    }
